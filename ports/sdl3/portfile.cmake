vcpkg_from_github(
    ...
    REPO libsdl-org/SDL
    REF 14c31ee12a6456db78ad3ff2f100391416ee38a0
    SHA512 e6b3b2bbc7f89d525924018f7aeef273209dedcff29e2accd8bc67b52caf677c430292d0e346b490c1f26142471025d00209d08824900b2bed826d3fd645beab
    HEAD_REF main
    PATCHES
        fix-freebsd.patch
        triton-imu.patch
...
if(WIN32)
    set(LIBUSB_OPTION "-DSDL_HIDAPI_LIBUSB_SHARED=OFF")
else()
    set(LIBUSB_OPTION "-DCMAKE_DISABLE_FIND_PACKAGE_LibUSB=1")
endif()
